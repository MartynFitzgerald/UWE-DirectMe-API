...
exports.insert = function(req, res, next) {
  crud.create(`INSERT IGNORE INTO external_provider (external_provider_id, name, place_id, reference, rating, user_ratings_total) VALUES ("${req.body.external_provider_id}","${req.body.name}", "${req.body.place_id}", "${req.body.reference}", "${req.body.rating}", "${req.body.user_ratings_total}");`, req, res, next);
}
