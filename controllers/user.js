...
exports.insert = function(req, res, next) {
  crud.insert(`INSERT IGNORE INTO user (user_id, fName, lName, email_address, password, phone_number, darkmode, radius) VALUES ("${req.body.user_id}","${req.body.fName}", "${req.body.lName}", "${req.body.email_address}", "${req.body.password}", "${req.body.phone_number}", 0, 1500);`, req, res, next);
}
