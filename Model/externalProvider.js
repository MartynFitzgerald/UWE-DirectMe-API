...
exports.update_by_id = function(req, res, next) {
  crud.update(`UPDATE external_provider SET name='${req.body.name}', place_id='${req.body.place_id}', reference='${req.body.reference}', rating=${req.body.rating}, user_rating_total=${req.body.user_rating_total} WHERE external_provider_id='${req.body.id}';`, req, res, next);
}
